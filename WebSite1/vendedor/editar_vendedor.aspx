<%@ Page Language="VB" AutoEventWireup="false" CodeFile="editar_vendedor.aspx.vb" Inherits="registar_cliente" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
                   Morada&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox_morada" runat="server" AutoPostBack="True" MaxLength="9" Height="86px" TextMode="MultiLine" Width="343px"></asp:TextBox>
                   &nbsp;<br />
        <br />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="gerir_produtos.aspx.vb" Inherits="vendedor_gerir_produtos" %>
        ...
        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="logout.aspx">Logout</asp:HyperLink>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None">
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="id_produto" DataNavigateUrlFormatString="editar_produto.aspx?id={0}" Text="Editar" />
                            <asp:HyperLinkField DataNavigateUrlFields="id_produto" DataNavigateUrlFormatString="remover_produto.aspx?id={0}" Text="Remover" />
                        </Columns>

...
Partial Class _Default
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (TextBox_nome.Text = "" Or TextBox_nif.Text = "" Or TextBox_tlf.Text = "" Or TextBox_morada.Text = "" Or TextBox_taxa.Text = "" Or TextBox_email.Text = "" Or TextBox_password.Text = "") Then
        ...
        Else
            Using con As New OracleConnection(ConfigurationManager.ConnectionStrings("conexao").ConnectionString.ToString())
                Dim cmd As New OracleCommand("pack_vendedor.inserir_vendedor", con)
                ...
                cmd.Parameters.Add(New OracleParameter("taxa", OracleType.Float))
                ...
                cmd.Parameters("taxa").Value = TextBox_taxa.Text

    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            Using con As New OracleConnection(ConfigurationManager.ConnectionStrings("conexao").ConnectionString.ToString())
                Dim cmd As New OracleCommand("login_cliente", con)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add(New OracleParameter("clienteid", OracleType.Number)).Direction = ParameterDirection.ReturnValue
                ...
                Try
                    cmd.ExecuteNonQuery()
                    Session("id_cliente") = cmd.Parameters("clienteid").Value
